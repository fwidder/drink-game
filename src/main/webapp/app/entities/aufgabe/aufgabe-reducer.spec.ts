...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aufgabe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUFGABE_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUFGABE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUFGABE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUFGABE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUFGABE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUFGABE actions', async () => {
      const expectedActions = [
        {
