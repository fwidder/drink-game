...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './spiel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPIEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPIEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPIEL actions', async () => {
      const expectedActions = [
        {
