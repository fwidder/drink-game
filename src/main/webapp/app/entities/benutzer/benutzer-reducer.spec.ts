...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './benutzer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENUTZER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BENUTZER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BENUTZER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BENUTZER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BENUTZER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BENUTZER actions', async () => {
      const expectedActions = [
        {
