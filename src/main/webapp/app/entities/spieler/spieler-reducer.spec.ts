...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './spieler.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPIELER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPIELER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPIELER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPIELER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPIELER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPIELER actions', async () => {
      const expectedActions = [
        {
