...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './getraenk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GETRAENK_LIST actions', async () => {
    ...
    it('dispatches FETCH_GETRAENK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GETRAENK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GETRAENK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GETRAENK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GETRAENK actions', async () => {
      const expectedActions = [
        {
